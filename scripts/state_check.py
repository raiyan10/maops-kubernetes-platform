...
def capture_suite_baseline(pvc_uid: str | None, pv_uid: str | None) -> None:
    ...
    Only active when both DAY4_RUN_ID and DAY4_SUITE_BASELINE_PATH are
    set (the Makefile sets both, once per `make day4-check` invocation,
    ...
    day4-check sequence up to and including this script - state-check
